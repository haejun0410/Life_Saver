...
firstaidList=[
        ...
        {"tag": "Broken",
         "responses": "1)To help decrease pain and swelling in a broken,  ice the injury \n2)Depending on the severity of the fracture, the broken part may need to be put back into place (reduced), and some compound fractures may require surgery.\n3) Most broken heal without complications in six weeks."
        },
        {"tag": "Choking",
